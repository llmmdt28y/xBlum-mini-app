...
export function ProfileView() {
  ...
  return (
    <div className="flex-1 overflow-y-auto flex flex-col relative bg-[#000000] text-white animate-in fade-in duration-300 min-h-[var(--tg-viewport-stable-height,100dvh)]">
