...
export function MarketView() {
  ...
  return (
    <>
      ...
      {/* ── CONDICIONAL: VISTA DE DETALLE O VISTA PRINCIPAL ── */}
      {viewingBoxId && activeBoxData ? (
        ...
        <div className="flex-1 overflow-y-auto relative animate-in slide-in-from-right-8 fade-in duration-300 bg-[#000000] pb-32">
          ...
          {/* Header Detalle (Actualizado con saldo igual al inicio) */}
          <div className="sticky top-0 z-40 flex items-center justify-between px-5 pt-14 pb-4 bg-black">
             ...
             <div className="bg-[#1c1c1e]/85 backdrop-blur-md rounded-full p-1 pl-3 flex items-center gap-2 border border-[#2c2c2e] shadow-lg shadow-black/40 transition-all">
          ...
          <div className="flex flex-col px-5 pt-6 items-center">
             ...
             <div className="w-full flex flex-col items-center mb-8 relative">
                ...
                <div className="flex items-center justify-center w-full gap-3 overflow-hidden px-2">
                   {/* Tarjeta ? (-2) */}
                   <div className="w-[50px] h-[60px] bg-gradient-to-b from-[#0a0a0b] to-[#000000] rounded-[14px] flex flex-shrink-0 items-center justify-center border border-[#1c1c1e] opacity-30">
                      <span className="text-white/30 font-bold text-xl" style={{ fontFamily: SFD }}>?</span>
                   </div>
                   
                   {/* Tarjeta ? (-1) */}
                   <div className="w-[70px] h-[90px] bg-[#0d0d0f] rounded-[18px] flex flex-shrink-0 items-center justify-center border border-[#2c2c2e] shadow-md opacity-60">
                      <span className="text-white/50 font-bold text-3xl drop-shadow-md" style={{ fontFamily: SFD }}>?</span>
                   </div>
                   
                   {/* Caja Central Activa */}
                   <div className="w-[140px] h-[160px] bg-[#111111] flex-shrink-0 rounded-[28px] flex flex-col items-center justify-center border border-[#3b82f6]/40 shadow-[0_0_30px_rgba(59,130,246,0.15)] relative z-10">
      ...
      {/* ── MODAL TOP UP ── (Global para ambas vistas) */}
      {isTopUpOpen && (
