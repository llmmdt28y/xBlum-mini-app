...
export function PremiumView() {
  ...
  return (
    <div className="flex-1 min-h-[var(--tg-viewport-stable-height,100dvh)] flex flex-col bg-[#000000] fixed top-0 left-0 w-full h-full z-[70] overflow-y-auto overscroll-none text-white pb-32 animate-in fade-in zoom-in-[0.98] duration-200 ease-out" style={{ fontFamily: SFD }}>
      {isHeavy && (
