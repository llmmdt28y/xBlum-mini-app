...
export function SettingsView() {
  ...
  // improveModel es estático por ahora
    ...
    <div className="flex-1 bg-[#0a0a0a]">
      ...
      <div className="px-4 pt-6 pb-8 space-y-6">
        ...
        <div>
          ...
          {/* Single container with all rows like store style */}
        ...
        <div>
          ...
          <div className="bg-neutral-900 rounded-2xl overflow-hidden divide-y divide-neutral-800">
            ...
            <div className="w-full flex items-center gap-4 px-4 py-4">
              ...
              {/* iOS-style switch */}
              <button
                onClick={() => setPersonalizeMemories(!personalizeMemories)}
                className={
              ...
              >
                <span
                  className={
                    "absolute top-[2px] w-[27px] h-[27px] rounded-full bg-white shadow-md transition-transform duration-200 " +
            ...
            >
              <div className="flex-1 text-left pl-14">
                <p className="font-medium text-red-500">{t("deleteAllMemories")}</p>
              </div>
            </button>
            ...
            >
              <div className="flex-1 text-left pl-14">
                <p className="font-medium text-red-500">{t("deleteAllHistory")}</p>
              </div>
            </button>
          </div>
        </div>
