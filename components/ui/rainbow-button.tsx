...
const rainbowButtonVariants = cva(
  ...
  ),
  {
    variants: {
      variant: {
        default:
          "border-0 bg-[linear-gradient(#161616,#161616),linear-gradient(#161616_50%,rgba(22,22,22,0.6)_80%,transparent),linear-gradient(90deg,var(--color-1),var(--color-5),var(--color-3),var(--color-4),var(--color-2))] bg-[length:200%] text-white [background-clip:padding-box,border-box,border-box] [background-origin:border-box] [border:calc(1.5px)_solid_transparent] before:absolute before:bottom-[-20%] before:left-1/2 before:z-0 before:h-1/5 before:w-3/5 before:-translate-x-1/2 before:animate-rainbow before:bg-[linear-gradient(90deg,var(--color-1),var(--color-5),var(--color-3),var(--color-4),var(--color-2))] before:bg-[length:200%] before:[filter:blur(0.75rem)] hover:bg-[linear-gradient(#1e1e1e,#1e1e1e),linear-gradient(#1e1e1e_50%,rgba(30,30,30,0.6)_80%,transparent),linear-gradient(90deg,var(--color-1),var(--color-5),var(--color-3),var(--color-4),var(--color-2))] shadow-sm active:scale-95",
        outline:
